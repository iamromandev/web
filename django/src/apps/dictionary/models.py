...
class Definition(SoftDeleteModel):
    ...
    attribution = models.ForeignKey(Attribution, related_name="definitions", blank=True, null=True, on_delete=models.DO_NOTHING)
...
class Example(SoftDeleteModel):
    ...
    definition = models.ForeignKey(Definition, related_name='examples', blank=True, null=True,
